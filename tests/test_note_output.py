...
def test_note_source_marker_survives_metadata_citation_replacement():
    doc = SimpleNamespace(other={"ref": "Paper", "chunk_source": "note"}, citation="Paper title")
    context = SimpleNamespace(context="Summary", text=SimpleNamespace(name="id-note chunk 1", doc=doc))
